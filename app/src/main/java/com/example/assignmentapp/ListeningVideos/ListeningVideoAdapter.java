...
public class ListeningVideoAdapter extends ArrayAdapter<ListeningVideoDetails> {

   public ListeningVideoAdapter(Context context, List<ListeningVideoDetails> items) {
