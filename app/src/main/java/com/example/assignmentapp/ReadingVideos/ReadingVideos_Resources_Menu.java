...
public class ReadingVideos_Resources_Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReadingVideoAdapter adapter = new ReadingVideoAdapter(this, ReadingVideoDetails.getMyVideos());
    ...
    AdapterView.OnItemClickListener playVideo = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            ArrayList<ReadingVideoDetails> videoDetails = ReadingVideoDetails.getMyVideos();
            ...
            Toast.makeText(ReadingVideos_Resources_Menu.this, title, Toast.LENGTH_SHORT).show();
